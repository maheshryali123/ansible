yIn before the user management is below
ubuntu@ip-172-31-82-168:/opt/wildfly/domain/configuration$ sudo cat mgmt-users.properties
#
...
#
After giving username and password the following changes have made.
ubuntu@ip-172-31-82-168:/opt/wildfly/domain/configuration$ sudo cat mgmt-users.properties
#
# Properties declaration of users for the realm 'ManagementRealm' which is the default realm
# for new installations. Further authentication mechanism can be configured
...
mahesh=e2c4f84bce78e0c8e417416e3d908a31
